            ...
            <div class="viewport">
                <div class="widget mb50">
                    ...
                    <div>
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{ asset('user/assets/img/widget/widget3.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{ asset('user/assets/img/widget/widget4.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img class="widget-img" src="{{ asset('user/assets/img/widget/widget5.jpg')}}" alt="">
                            </div>
                            <div class="media-body">
