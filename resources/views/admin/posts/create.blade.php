      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('admin.blog.store') }}" method="post" class="was-validated" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      {{-- <input type="text" class="form-control {{ $errors->has('introduce') ? 'is-invalid' : '' }}" id="introduce" name="introduce" placeholder="Le sous titre de l'article" value="{{ old('introduce') ?? $post->introduce }}" required> --}}
